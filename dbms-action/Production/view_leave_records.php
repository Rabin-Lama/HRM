    ...
    <div class="table-responsive">
        <table class="table-condensed view-table">
            ...
            <?php
                if($val == 'all')
                    {
                        $rquery1 = "SELECT * FROM table_leave WHERE department = '$dpt'";
                    }
                elseif($val == 'accepted')
                    {
                        $rquery1 = "SELECT * FROM table_leave WHERE department = '$dpt' AND status = 'accepted'";
                    }
                else
                    {
                        $rquery1 = "SELECT * FROM table_leave WHERE department = '$dpt' AND status = 'declined'";
                    }

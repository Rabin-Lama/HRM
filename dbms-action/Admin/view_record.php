...
<head>
<meta charset="utf-8">
<title>View and manage records</title>
    <link rel="stylesheet" href="../../css/bootstrap.min.css">
    <link rel="stylesheet" href="../../css/bootstrap-theme.min.css">
    <link rel="stylesheet" href="../../font2/css/font-awesome.min.css">
        ...
        <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" >
            	<ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="">View and manage records</a></li>
                    <li class="dropdown">
                        <a href="" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
    ...
    <div class="table-responsive">
        <table class="table-condensed view-table">
            <tr class="info">
                ...
                <th>Salary (NRS)</th>
                <th colspan="3" style="color:red;">Select an action</th>
            </tr>
            <?php
                $rquery2 = "SELECT * FROM table_employee ORDER BY first_name ASC";
            ...
            ?>
                                <tr>
                                    ...
                                    <td><a href="delete_record.php?id=<?php echo $data2['id']; ?>"><i class="fa fa-trash fa-2x hov"></i></a></td>
                                    <td><a href="print.php?id=<?php echo $data2['id']; ?>"><i class="fa fa-print fa-2x hov"></i></a></td>
                                </tr>
            <?php
                            }
                     }
